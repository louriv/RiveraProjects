...
<html lang="en" dir="ltr">
     ...
     <title>Royal Technology | Louis A. Rivera Jr. | Rivera Projects, LLC</title>
     </head>
...
<hr/>
      ...
      <div class="row">
        <div class="col">
          <div class="text-container">
            <img src="../img/rp-5.jpg" alt="Rivera Projects polo shirts" class="img-thumbnail d-none d-md-block img-fluid ">

            </div>
        </div>
    <div class="col">
        <div class="text-container">
    <img src="../img/rp-3.jpg" alt="Rivera Projects consulting at a table" class="img-thumbnail d-none d-md-block img-fluid ">
    ...
    <div class="col">
    <div class="text-container">
      <img src="../img/rp-2.jpg" alt="Rivera Projects at the a local fair" class="img-thumbnail d-none d-md-block img-fluid ">
