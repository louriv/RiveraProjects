...
To get back to the point, I wanted to stress that this is an added reminder for me that life is continuously and constantly pushing forward. We all need to push forward and continue to learn and grow as individuals to understand who we are. This will help us better translate goals and needs in the workplace while keeping us sharp. Walking away is a personal choice and one that I am ready for. The next step of my journey includes finishing my masters and continuing to grow and nurture my career in the best way possible. Looking back I wouldn't change a thing. I was able to watch myself learn and grow in such a unique way. It has become who I am and I am beyond proud of that fact.
    ...
    <div class="container">
      <div class="row">
        ...
        <img src="../riveraprojects/img/rp-1.jpg" alt="Rivera Projects, LLC" class="img-thumbnail d-none d-md-block img-fluid portfolio-items">

        </div>
      </div>
      <div class="col">
          <div class="text-container">
      <img src="../riveraprojects/img/rp-2.jpg" alt="Rivera Projects, LLC" class="img-thumbnail d-none d-md-block img-fluid portfolio-items">

      </div>
    </div>
    <div class="col">
        <div class="text-container">
    <img src="../riveraprojects/img/rp-3.jpg" alt="Rivera Projects, LLC" class="img-thumbnail d-none d-md-block img-fluid portfolio-items">

    </div>
  </div>
  <div class="col">
      <div class="text-container">
  <img src="../riveraprojects/img/rp-4.jpg" alt="Rivera Projects, LLC" class="img-thumbnail d-none d-md-block img-fluid portfolio-items">

  </div>
</div>
<div class="col">
    <div class="text-container">
<img src="../riveraprojects/img/rp-5.jpg" alt="Rivera Projects, LLC" class="img-thumbnail d-none d-md-block img-fluid portfolio-items">
